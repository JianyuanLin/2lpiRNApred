function out = piRNApredictor(filepath)
addpath('./SVMMDRBF');
...
%%%%%%%%%%%%%%%%%%%%%%
%  %PC-PseDNC-General
% system('python ./Pse-in-One-2.0/psee.pyc ./inst_positivetest89.txt RNA PC-PseDNC-General -w 0.5 -lamada 6 -i propChosen.txt -f tab -labels 0 -out PC3.txt');
% system('python ./Pse-in-One-2.0/psee.pyc ./inst_positivetest89.txt RNA PC-PseDNC-General -w 0.2 -lamada 9 -i propChosen.txt -f tab -labels 0 -out PC7.txt');
% system('python ./Pse-in-One-2.0/psee.pyc ./inst_positivetest89.txt RNA PC-PseDNC-General -w 0.2 -lamada 7 -i propChosen.txt -f tab -labels 0 -out PC8.txt');
% %Kmer
% system('	');
...
%
PC3 = load([filepath,'/PC3.txt']);
PC7 = load([filepath,'/PC7.txt']);
PC8 = load([filepath,'/PC8.txt']);
Kmer1 = load([filepath,'/Kmer1.txt']);
...
test3=test3(:,index3);
ytest3=ones(n,1);
%[M_struct,SVM_model_struct]=DAGSVMMDRBF_train(Train3,Train_labels3);
%load testdata.mat
